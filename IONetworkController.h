...
*/
    //REVIEW: had to comment out this static function (does not affect vtable layout)
    //  IOMbufServiceClass is undefined -- probably in some private header
    //  or in __PRIVATE_SPI__ part of existing header..
